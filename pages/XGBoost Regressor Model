...
aa=list(diamond_df[diamond_df['color']=='M'].index)[0]
...
aa=list(diamond_df[diamond_df['clarity']=='WS2'].index)[0]
dict_clarity['WS2']=label_data.loc[aa,'clarity']
aa=list(diamond_df[diamond_df['clarity']=='WS1'].index)[0]
dict_clarity['WS1']=label_data.loc[aa,'clarity']
